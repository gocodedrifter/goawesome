...
type Message struct {
	...
	TransactionAmount        TransactionAmount `bson:"transactionAmount" json:"transactionAmount,omitempty"`
	...
	OriginalData             OriginalData      `bson:"originalData" json:"originalData,omitempty"`
